...
def get_args():
    ...
    parser.add_argument('--epochs_number', type=int, default=12, help='epoch number for training')
    ...
    parser.add_argument('--root_path', type=str, default='/kaggle/working/backet_classification/data/MnistData', help='path to dataset')
